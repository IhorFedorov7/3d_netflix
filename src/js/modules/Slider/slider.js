...
export const Slider = ( obj ) => {
    ...
    for ( let i in obj ) {
        ...
        const objOption = {
            ...
            position: 0,
            conteiner: null,
            prev: el.querySelector('#btn-prev') == null ? document.querySelector('#btn-prev') : el.querySelector('#btn-prev'),
            next: el.querySelector('#btn-next') == null ? document.querySelector('#btn-next') : el.querySelector('#btn-next'),
